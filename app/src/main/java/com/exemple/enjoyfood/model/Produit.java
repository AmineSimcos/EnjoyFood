...
public class Produit {
    ...
    public Produit(String code_bar, String titre, String titre_en, String titre_ar, String description, String desc_en, String desc_ar, String image, String categorie, double energie, double matiere_grasse, double graisse, double glucide, double sucre, double proteine, double fibre, double sodium, double sel, double calicium, double potassium, double sulfates, double magnesium, double chlorures, double nitrates, double nitrites, double fluor, double residus_secs, double bicarbonates, double silices, double ph, int fruits_legumes, String ingrediant, String ingrediant_en, String ingrediant_ar, int volume) {
        this.code_bar = code_bar;
        this.titre = titre;
        this.titre_en = titre_en;
        this.titre_ar = titre_ar;
        ...
        this.chlorures = chlorures;
        this.nitrates = nitrates;
        this.nitrites = nitrites;
        this.fluor = fluor;
        this.residus_secs = residus_secs;
        this.bicarbonates = bicarbonates;
        this.silices = silices;
        this.ph = ph;
        this.fruits_legumes = fruits_legumes;
        this.ingrediant = ingrediant;
        this.ingrediant_en = ingrediant_en;
